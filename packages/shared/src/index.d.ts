...
export interface CheckpointState {
  ...
  taskCheckpoints: Record<string, Partial<Record<TaskCheckpointAgent, CheckpointRecord>>>;
}
...
export function initCheckpointState(classification: TaskClassification, classificationReason: string): CheckpointState;
...
export function consumePlannerCheckpoint(state: CheckpointState): CheckpointState;
