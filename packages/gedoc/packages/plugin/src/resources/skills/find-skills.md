...
- Help decide whether GedOC already has enough skill coverage for the task.
...
2. Inventory available bundled/project/user skills from `.ged/SKILLS.md` and `gedoc_list_skills`.
...
7. Ask the user before installing anything outside the project; GedOC's automatic fallback creates only local `.ged/skills/` skills.
