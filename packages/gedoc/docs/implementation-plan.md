...
- [x] define release metadata for GedOC binaries and compatible OpenCode runtime targets
...
- launcher-generated config loads only the GedOC plugin when started through `gedoc`
- OpenCode resolves `default_agent: gedoc`
- GedOC commands and tools are registered in a real OpenCode runtime
