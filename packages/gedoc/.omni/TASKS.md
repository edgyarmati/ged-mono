...
- Prefer narrow backports that match GedOC's simpler architecture rather than copying GedPi internals wholesale.
...
- [x] Slice 1: add explicit `gedoc_start_work` branch workflow tool, dirty checkout guidance, tests, docs, verify, and commit.
